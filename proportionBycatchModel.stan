// Data is actually in pounds, not numbers. I was on the wrong track with binomial draws

// Try beta proportion distribution? theta ~ beta_proportion(mu, kappa), mu is mean, kappa is precision
